...
**Modules**
* DEG utilizes Javascript modules to create a maintainable, reusable, and performant codebase as opposed to a codebase that is sprawling and interdependent.
